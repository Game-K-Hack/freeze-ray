...
namespace FreezeRay
{
    ...
    internal static class Strings
    {
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string>
        {
            ...
            { "setup.title", "Freeze Ray — Setup" },
            { "setup.licenseTitle", "Licence" },
            { "setup.licenseIntro", "Please read and accept the licence to continue." },
            { "setup.accept", "I accept the terms of the licence" },
            { "setup.next", "Next" },
            { "setup.back", "Back" },
            { "setup.install", "Install" },
            { "setup.cancel", "Cancel" },
            { "setup.close", "Close" },
            { "setup.optionsTitle", "Installation options" },
            { "setup.folder", "Install to:" },
            { "setup.browse", "Browse…" },
            { "setup.folderNote", "The settings file is kept in this folder, next to the application." },
            { "setup.desktopShortcut", "Create a shortcut on the desktop" },
            { "setup.startMenuShortcut", "Add to the Start menu" },
            { "setup.done", "Freeze Ray is installed." },
            { "setup.launch", "Start Freeze Ray now" },
            { "setup.error", "Installation failed: {0}" },
            { "setup.running", "Freeze Ray is running. Close it, then try again." },
            { "uninstall.confirm", "Remove Freeze Ray, its shortcuts and its settings?" },
            { "uninstall.done", "Freeze Ray has been removed." },
        };
        ...
        private static readonly Dictionary<string, string> Fr = new Dictionary<string, string>
        {
            ...
            { "setup.title", "Freeze Ray — Installation" },
            { "setup.licenseTitle", "Licence" },
            { "setup.licenseIntro", "Veuillez lire et accepter la licence pour continuer." },
            { "setup.accept", "J'accepte les termes de la licence" },
            { "setup.next", "Suivant" },
            { "setup.back", "Précédent" },
            { "setup.install", "Installer" },
            { "setup.cancel", "Annuler" },
            { "setup.close", "Fermer" },
            { "setup.optionsTitle", "Options d'installation" },
            { "setup.folder", "Installer dans :" },
            { "setup.browse", "Parcourir…" },
            { "setup.folderNote", "Le fichier de réglages est conservé dans ce dossier, à côté de l'application." },
            { "setup.desktopShortcut", "Créer un raccourci sur le bureau" },
            { "setup.startMenuShortcut", "Ajouter au menu Démarrer" },
            { "setup.done", "Freeze Ray est installé." },
            { "setup.launch", "Lancer Freeze Ray maintenant" },
            { "setup.error", "Installation impossible : {0}" },
            { "setup.running", "Freeze Ray est en cours d'exécution. Fermez-le puis réessayez." },
            { "uninstall.confirm", "Supprimer Freeze Ray, ses raccourcis et ses réglages ?" },
            { "uninstall.done", "Freeze Ray a été supprimé." },
        };
        ...
        private static readonly Dictionary<string, string> De = new Dictionary<string, string>
        {
            ...
            { "setup.title", "Freeze Ray — Installation" },
            { "setup.licenseTitle", "Lizenz" },
            { "setup.licenseIntro", "Bitte lesen und akzeptieren Sie die Lizenz, um fortzufahren." },
            { "setup.accept", "Ich akzeptiere die Lizenzbedingungen" },
            { "setup.next", "Weiter" },
            { "setup.back", "Zurück" },
            { "setup.install", "Installieren" },
            { "setup.cancel", "Abbrechen" },
            { "setup.close", "Schließen" },
            { "setup.optionsTitle", "Installationsoptionen" },
            { "setup.folder", "Installieren nach:" },
            { "setup.browse", "Durchsuchen…" },
            { "setup.folderNote", "Die Einstellungsdatei bleibt in diesem Ordner, neben der Anwendung." },
            { "setup.desktopShortcut", "Verknüpfung auf dem Desktop anlegen" },
            { "setup.startMenuShortcut", "Zum Startmenü hinzufügen" },
            { "setup.done", "Freeze Ray ist installiert." },
            { "setup.launch", "Freeze Ray jetzt starten" },
            { "setup.error", "Installation fehlgeschlagen: {0}" },
            { "setup.running", "Freeze Ray läuft. Bitte beenden und erneut versuchen." },
            { "uninstall.confirm", "Freeze Ray samt Verknüpfungen und Einstellungen entfernen?" },
            { "uninstall.done", "Freeze Ray wurde entfernt." },
        };
        ...
        private static readonly Dictionary<string, string> Es = new Dictionary<string, string>
        {
            ...
            { "setup.title", "Freeze Ray — Instalación" },
            { "setup.licenseTitle", "Licencia" },
            { "setup.licenseIntro", "Lee y acepta la licencia para continuar." },
            { "setup.accept", "Acepto los términos de la licencia" },
            { "setup.next", "Siguiente" },
            { "setup.back", "Atrás" },
            { "setup.install", "Instalar" },
            { "setup.cancel", "Cancelar" },
            { "setup.close", "Cerrar" },
            { "setup.optionsTitle", "Opciones de instalación" },
            { "setup.folder", "Instalar en:" },
            { "setup.browse", "Examinar…" },
            { "setup.folderNote", "El archivo de configuración se guarda en esta carpeta, junto a la aplicación." },
            { "setup.desktopShortcut", "Crear un acceso directo en el escritorio" },
            { "setup.startMenuShortcut", "Añadir al menú Inicio" },
            { "setup.done", "Freeze Ray está instalado." },
            { "setup.launch", "Iniciar Freeze Ray ahora" },
            { "setup.error", "No se pudo instalar: {0}" },
            { "setup.running", "Freeze Ray está en ejecución. Ciérralo e inténtalo de nuevo." },
            { "uninstall.confirm", "¿Eliminar Freeze Ray, sus accesos directos y su configuración?" },
            { "uninstall.done", "Freeze Ray se ha eliminado." },
        };
        ...
        private static readonly Dictionary<string, string> It = new Dictionary<string, string>
        {
            ...
            { "setup.title", "Freeze Ray — Installazione" },
            { "setup.licenseTitle", "Licenza" },
            { "setup.licenseIntro", "Leggi e accetta la licenza per continuare." },
            { "setup.accept", "Accetto i termini della licenza" },
            { "setup.next", "Avanti" },
            { "setup.back", "Indietro" },
            { "setup.install", "Installa" },
            { "setup.cancel", "Annulla" },
            { "setup.close", "Chiudi" },
            { "setup.optionsTitle", "Opzioni di installazione" },
            { "setup.folder", "Installa in:" },
            { "setup.browse", "Sfoglia…" },
            { "setup.folderNote", "Il file delle impostazioni resta in questa cartella, accanto all'applicazione." },
            { "setup.desktopShortcut", "Crea un collegamento sul desktop" },
            { "setup.startMenuShortcut", "Aggiungi al menu Start" },
            { "setup.done", "Freeze Ray è installato." },
            { "setup.launch", "Avvia Freeze Ray adesso" },
            { "setup.error", "Installazione non riuscita: {0}" },
            { "setup.running", "Freeze Ray è in esecuzione. Chiudilo e riprova." },
            { "uninstall.confirm", "Rimuovere Freeze Ray, i suoi collegamenti e le sue impostazioni?" },
            { "uninstall.done", "Freeze Ray è stato rimosso." },
        };
        ...
        private static readonly Dictionary<string, string> Ja = new Dictionary<string, string>
        {
            ...
            { "setup.title", "Freeze Ray — セットアップ" },
            { "setup.licenseTitle", "ライセンス" },
            { "setup.licenseIntro", "続行するにはライセンスをお読みのうえ同意してください。" },
            { "setup.accept", "ライセンスの条項に同意します" },
            { "setup.next", "次へ" },
            { "setup.back", "戻る" },
            { "setup.install", "インストール" },
            { "setup.cancel", "キャンセル" },
            { "setup.close", "閉じる" },
            { "setup.optionsTitle", "インストール オプション" },
            { "setup.folder", "インストール先:" },
            { "setup.browse", "参照…" },
            { "setup.folderNote", "設定ファイルはアプリケーションと同じこのフォルダーに保存されます。" },
            { "setup.desktopShortcut", "デスクトップにショートカットを作成する" },
            { "setup.startMenuShortcut", "スタート メニューに追加する" },
            { "setup.done", "Freeze Ray をインストールしました。" },
            { "setup.launch", "今すぐ Freeze Ray を起動する" },
            { "setup.error", "インストールできませんでした: {0}" },
            { "setup.running", "Freeze Ray が実行中です。終了してからやり直してください。" },
            { "uninstall.confirm", "Freeze Ray とショートカット、設定を削除しますか？" },
            { "uninstall.done", "Freeze Ray を削除しました。" },
        };
        ...
        private static readonly Dictionary<string, string> Ko = new Dictionary<string, string>
        {
            ...
            { "setup.title", "Freeze Ray — 설치" },
            { "setup.licenseTitle", "라이선스" },
            { "setup.licenseIntro", "계속하려면 라이선스를 읽고 동의하세요." },
            { "setup.accept", "라이선스 조항에 동의합니다" },
            { "setup.next", "다음" },
            { "setup.back", "뒤로" },
            { "setup.install", "설치" },
            { "setup.cancel", "취소" },
            { "setup.close", "닫기" },
            { "setup.optionsTitle", "설치 옵션" },
            { "setup.folder", "설치 위치:" },
            { "setup.browse", "찾아보기…" },
            { "setup.folderNote", "설정 파일은 애플리케이션과 같은 이 폴더에 보관됩니다." },
            { "setup.desktopShortcut", "바탕 화면에 바로 가기 만들기" },
            { "setup.startMenuShortcut", "시작 메뉴에 추가" },
            { "setup.done", "Freeze Ray를 설치했습니다." },
            { "setup.launch", "지금 Freeze Ray 실행" },
            { "setup.error", "설치하지 못했습니다: {0}" },
            { "setup.running", "Freeze Ray가 실행 중입니다. 종료한 뒤 다시 시도하세요." },
            { "uninstall.confirm", "Freeze Ray와 바로 가기, 설정을 제거할까요?" },
            { "uninstall.done", "Freeze Ray를 제거했습니다." },
        };
        ...
        private static readonly Dictionary<string, string> Ru = new Dictionary<string, string>
        {
            ...
            { "setup.title", "Freeze Ray — установка" },
            { "setup.licenseTitle", "Лицензия" },
            { "setup.licenseIntro", "Прочитайте и примите лицензию, чтобы продолжить." },
            { "setup.accept", "Я принимаю условия лицензии" },
            { "setup.next", "Далее" },
            { "setup.back", "Назад" },
            { "setup.install", "Установить" },
            { "setup.cancel", "Отмена" },
            { "setup.close", "Закрыть" },
            { "setup.optionsTitle", "Параметры установки" },
            { "setup.folder", "Установить в:" },
            { "setup.browse", "Обзор…" },
            { "setup.folderNote", "Файл настроек хранится в этой папке, рядом с приложением." },
            { "setup.desktopShortcut", "Создать ярлык на рабочем столе" },
            { "setup.startMenuShortcut", "Добавить в меню «Пуск»" },
            { "setup.done", "Freeze Ray установлен." },
            { "setup.launch", "Запустить Freeze Ray сейчас" },
            { "setup.error", "Не удалось установить: {0}" },
            { "setup.running", "Freeze Ray запущен. Закройте его и повторите попытку." },
            { "uninstall.confirm", "Удалить Freeze Ray, его ярлыки и настройки?" },
            { "uninstall.done", "Freeze Ray удалён." },
        };
        ...
        private static readonly Dictionary<string, string> Zh = new Dictionary<string, string>
        {
            ...
            { "setup.title", "Freeze Ray — 安装" },
            { "setup.licenseTitle", "许可协议" },
            { "setup.licenseIntro", "请阅读并接受许可协议以继续。" },
            { "setup.accept", "我接受许可协议的条款" },
            { "setup.next", "下一步" },
            { "setup.back", "上一步" },
            { "setup.install", "安装" },
            { "setup.cancel", "取消" },
            { "setup.close", "关闭" },
            { "setup.optionsTitle", "安装选项" },
            { "setup.folder", "安装到：" },
            { "setup.browse", "浏览…" },
            { "setup.folderNote", "设置文件保存在此文件夹中，与应用程序放在一起。" },
            { "setup.desktopShortcut", "在桌面创建快捷方式" },
            { "setup.startMenuShortcut", "添加到开始菜单" },
            { "setup.done", "Freeze Ray 已安装。" },
            { "setup.launch", "立即启动 Freeze Ray" },
            { "setup.error", "安装失败：{0}" },
            { "setup.running", "Freeze Ray 正在运行。请关闭后重试。" },
            { "uninstall.confirm", "要删除 Freeze Ray、其快捷方式和设置吗？" },
            { "uninstall.done", "Freeze Ray 已删除。" },
        };
