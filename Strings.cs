...
namespace FreezeRay
{
    ...
    internal static class Strings
    {
        ...
        private static readonly Dictionary<string, string> De = new Dictionary<string, string>
        {
            ...
            { "settings.updates", "Updates" },
            { "settings.updateSource", "GitHub-Repository:" },
            { "settings.updateSourceHint", "In der Form besitzer/repository. Leer lassen, wenn nicht genutzt." },
            ...
            { "update.noSource", "Kein Repository angegeben: Bitte eines eintragen, um nach Updates zu suchen." },
        ...
        private static readonly Dictionary<string, string> Es = new Dictionary<string, string>
        {
            ...
            { "settings.updateSource", "Repositorio de GitHub:" },
            { "settings.updateSourceHint", "Con el formato propietario/repositorio. Déjalo vacío si no lo usas." },
            ...
            { "update.noSource", "No hay repositorio indicado: escribe uno para buscar actualizaciones." },
        ...
        private static readonly Dictionary<string, string> It = new Dictionary<string, string>
        {
            ...
            { "settings.updateSource", "Repository GitHub:" },
            { "settings.updateSourceHint", "Nel formato proprietario/repository. Lascia vuoto se non lo usi." },
            ...
            { "update.noSource", "Nessun repository indicato: inseriscine uno per cercare aggiornamenti." },
        ...
        private static readonly Dictionary<string, string> Ja = new Dictionary<string, string>
        {
            ...
            { "settings.updates", "更新" },
            { "settings.updateSource", "GitHub リポジトリ:" },
            { "settings.updateSourceHint", "所有者/リポジトリ の形式。使わない場合は空欄のままにします。" },
            ...
            { "update.noSource", "リポジトリが未設定です。更新を確認するには入力してください。" },
        ...
        private static readonly Dictionary<string, string> Ko = new Dictionary<string, string>
        {
            ...
            { "settings.updateSource", "GitHub 저장소:" },
            { "settings.updateSourceHint", "소유자/저장소 형식. 사용하지 않으면 비워 두세요." },
            ...
            { "update.noSource", "저장소가 지정되지 않았습니다. 업데이트를 확인하려면 입력하세요." },
        ...
        private static readonly Dictionary<string, string> Ru = new Dictionary<string, string>
        {
            ...
            { "settings.updateSource", "Репозиторий GitHub:" },
            { "settings.updateSourceHint", "В виде владелец/репозиторий. Оставьте пустым, если не используете." },
            ...
            { "update.noSource", "Репозиторий не указан: укажите его, чтобы проверять обновления." },
        ...
        private static readonly Dictionary<string, string> Zh = new Dictionary<string, string>
        {
            ...
            { "settings.updates", "更新" },
            { "settings.updateSource", "GitHub 仓库：" },
            { "settings.updateSourceHint", "格式为 所有者/仓库。不使用时请留空。" },
            { "settings.check", "检查更新" },
            { "settings.close", "关闭" },
            ...
            { "update.noSource", "未填写仓库：请填写后再检查更新。" },
